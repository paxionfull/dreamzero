...
SELFCOLLECT_DATA_ROOT=${SELFCOLLECT_DATA_ROOT:-"/mnt/public/algm/datasets/self_collect_lerobot_0.3.4"}

# Output directory for training checkpoints
OUTPUT_DIR=${OUTPUT_DIR:-"./checkpoints/selfcollect_ft"}
...
torchrun --nproc_per_node $NUM_GPUS --standalone groot/vla/experiment/experiment.py \
    report_to=wandb \
    data=dreamzero/selfcollect_relative \
    ...
    frame_seqlen=880 \
    save_strategy=no \
    selfcollect_data_root=$SELFCOLLECT_DATA_ROOT \
